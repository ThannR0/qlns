<template>
  <div>
    <h1 class="mb-8 font-bold text-3xl">Hợp Đồng</h1>
    ...
    <pagination :links="hopdong.links" />
  </div>
</template>
  ...
  watch: {
    form: {
      handler: throttle(function() {
        ...
        this.$inertia.replace(this.route('hopdong', Object.keys(query).length ? query : { remember: 'forget' }))
      }, 150),
      deep: true,
    },
  },
