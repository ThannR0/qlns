  ...
  <div>
   ...
   <div v-if="$page.props.auth.user.role == 2" class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('heso')">
        ...
        <div :class="isUrl('heso') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Hệ Số Lương</div>
      </inertia-link>
    </div>
    <div v-if="$page.props.auth.user.role == 2" class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('phucap')">
        ...
        <div :class="isUrl('phucap') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Lương Phụ Cấp</div>
      </inertia-link>
    </div>
    ...
    <div v-if="$page.props.auth.user.role > 0" class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('nghiviec')">
        ...
        <div :class="isUrl('nghiviec') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Nhân Viên Nghỉ Việc</div>
      </inertia-link>
    </div>
    <div v-if="$page.props.auth.user.role > 0" class="mb-4">
    ...
    <div v-if="$page.props.auth.user.role > 0" class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('khautru')">
        ...
        <div :class="isUrl('khautru') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Khẩu Trừ Chi Phí</div>
      </inertia-link>
    </div>
    <div v-if="$page.props.auth.user.role == 2" class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('bangchamcong')">
        ...
        <div :class="isUrl('bangchamcong') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Chấm Công Trong Ngày</div>
      </inertia-link>
    </div>
    <div v-if="$page.props.auth.user.role > 0" class="mb-4">
