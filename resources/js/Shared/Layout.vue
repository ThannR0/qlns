    ...
    <div class="md:flex md:flex-col">
      <div class="md:h-screen md:flex md:flex-col">
        <div class="md:flex md:flex-shrink-0">
          <div class="bg-indigo-600 md:flex-shrink-0 md:w-56 px-6 py-4 flex items-center justify-between md:justify-center">
            <inertia-link class="mt-1" href="/">
              <logo class="fill-white" width="120" height="28" />
            </inertia-link>
            <dropdown class="md:hidden" placement="bottom-end">
              <svg class="fill-white w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z" /></svg>
              <div slot="dropdown" class="mt-2 px-8 py-4 shadow-lg bg-gray-900 rounded">
                <main-menu />
              </div>
            </dropdown>
          </div>
          <div class="bg-white border-b w-full p-4 md:py-0 md:px-12 text-sm md:text-md flex justify-between items-center">
            <div class="mt-1 mr-4">Hệ Thống Web Quản Lí Nhân Sự Trong Doanh Nghiệp T</div>
            <dropdown class="mt-1" placement="bottom-end">
              ...
              <div slot="dropdown" class="mt-2 py-2 shadow-xl bg-white rounded text-sm">
                ...
                <inertia-link class="block px-6 py-2 hover:bg-indigo-500 hover:text-white" :href="route('chamcong', { nhanvien: $page.props.auth.user.nhanvien_id })">Chấm Công</inertia-link>
                ...
                <inertia-link v-if="$page.props.auth.user.role == 2" class="block px-6 py-2 hover:bg-indigo-500 hover:text-white" :href="route('users')">Quản Lý tài khoản và quyền hạn</inertia-link>
        ...
        <div class="md:flex md:flex-grow md:overflow-hidden">
          <main-menu class="hidden md:block bg-gray-900 flex-shrink-0 w-56 p-12 overflow-y-auto" />
